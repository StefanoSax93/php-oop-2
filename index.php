...
$customer1->cart->addProduct($food2, $accessory2, $toy1);
$customer2->cart->addProduct($food1, $accessory1, $toy2);
...
var_dump($customer1->cart->getProducts());

echo "<h1 class='text-uppercase'>carrello di: " . $customer2->getUserName() . "</h1>";
var_dump($customer2->cart->getProducts());
